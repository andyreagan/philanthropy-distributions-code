...
for i = 1:3
    ...
    %% first plot, religious non-corrected
    if i==1
        ...
        hold on;
        a = annotation('textarrow', [.24 .205], [.77 .725]-.18, 'String' , 'A','fontsize',pointersize,'Color',0.01*[1 1 1],'HeadWidth',5,'HeadLength',5);
        ...
        fill(X,Y,[153 204 255]/255);
        b = annotation('textarrow', [.23 .30], [.59 .59]-.33, 'String' , 'B','fontsize',pointersize,'Color',0.01*[1 1 1],'HeadWidth',5,'HeadLength',5);
    ...
    %% plot the double gifts
        ...
        gifts = [.65.*gifts .20.*gifts .1.*gifts .05.*gifts];
